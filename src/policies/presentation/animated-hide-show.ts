...
import { MetaView, MetaViewTerm, view } from "./presentation"
...
export const animatedHideShow = <T> (viewTerm: MetaViewTerm<T>): MetaView<T> => (value, meta) => {
  ...
  return html`
    ...
    >
      ${meta.$.state.showing ? view(viewTerm)(value, meta) : ""}
